...
const sampleCommunities = [
  {
    ...
    description: 'Сообщество для обмена опытом преподавания математики',
    members: 1234,
    posts: 567,
    isPublic: true,
    subject: 'Математика',
  ...
  },
  {
    ...
    description: 'Методические разработки для учителей начальных классов',
    members: 2341,
    posts: 891,
    isPublic: true,
  ...
  {
    id: '3',
    name: 'ЕГЭ и ОГЭ подготовка',
    description: 'Материалы и обсуждения подготовки к экзаменам',
    members: 3456,
    posts: 1234,
    isPublic: true,
    subject: 'Экзамены',
  ...
  {
    id: '4',
    name: 'Информатика в школе',
    description: 'Все о преподавании информатики',
    members: 876,
    posts: 234,
    isPublic: true,
    subject: 'Информатика',
